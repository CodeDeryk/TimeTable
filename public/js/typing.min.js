!function (a) {
    ...
    b.prototype = {
        constructor: b, init: function () {
            var a = this;
            this.replaceBaseText && this.strings.unshift(a.baseText), a.timeout = setTimeout(function () {
                var b = 0 === a.arrayPos && a.replaceBaseText ? a.baseText : a.strings[a.arrayPos];
                a.typewrite(b, a.strPos)
            }, a.startDelay)
        }, build: function () {
                ...
                d.timeout = setTimeout(function () {
                    ...
                    d.timeout = setTimeout(function () {
                        if (b === a.length) {
                            ...
                            var c = a.substr(0, b + 1), e = d.replaceBaseText ? c : d.baseText + c;
                            d.attr ? d.el.attr(d.attr, e) : d.el.text(e), b++, d.typewrite(a, b)
                        }
                    }, c)
                }, c)
            }
            ...
            if (this.stop !== !0) {
                ...
                d.timeout = setTimeout(function () {
                    var c = a.substr(0, b + 1), e = d.replaceBaseText ? c : d.baseText + c;
                    d.attr ? d.el.attr(d.attr, e) : d.el.text(e), b > d.stopNum ? (b--, d.backspace(a, b)) : b <= d.stopNum && (d.arrayPos++, d.arrayPos === d.strings.length ? (d.arrayPos = 0, d.init()) : d.typewrite(d.strings[d.arrayPos], b))
                }, c)
            }
        }, reset: function () {
            var a = this;
